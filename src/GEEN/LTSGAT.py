...
class Attention_Layer(nn.Module):
    ...
    def __init__(self):
        ...
        # 下面使用nn的Linear层来定义Q，K，V矩阵
        self.Q_linear = nn.Linear(256//4*3, 256//4*3, bias=False)
        self.K_linear = nn.Linear(256//4*3, 256//4*3, bias=False)
        self.V_linear = nn.Linear(256//4*3, 256//4*3, bias=False)
...
class mynet(nn.Module):
    def __init__(self):
        ...
        self.LSTM = BiLSTM(10,64//4*3)
        self.dropout1 = nn.Dropout(0.5)


        self.linear1 = nn.Linear(512//4*3,256//4*3)
        self.linear2 = nn.Linear(640//4*3,256//4*3)
        self.linear3 = nn.Linear(256//4*3,256//4*3)
        self.linear4 = nn.Linear(384//4*3,256//4*3)
        self.linear5 = nn.Linear(512//4*3,256//4*3)
        self.linear6 = nn.Linear(512//4*3,256//4*3)
        self.linear7 = nn.Linear(640//4*3,256//4*3)
        self.linear8 = nn.Linear(256//4*3,256//4*3)
        self.linear9 = nn.Linear(384//4*3,256//4*3)


        self.attention = Attention_Layer()


        self.linear_1 = nn.Linear(256//4*3, 512//4*3)
        self.linear_2 = nn.Linear(256//4*3, 640//4*3)
        self.linear_3 = nn.Linear(256//4*3, 256//4*3)
        self.linear_4 = nn.Linear(256//4*3, 384//4*3)
        self.linear_5 = nn.Linear(256//4*3, 512//4*3)
        self.linear_6 = nn.Linear(256//4*3, 512//4*3)
        self.linear_7 = nn.Linear(256//4*3, 640//4*3)
        self.linear_8 = nn.Linear(256//4*3, 256//4*3)
        self.linear_9 = nn.Linear(256//4*3, 384//4*3)
